...
def run_random_forest_analysis(visualize=False):
  # Carga de datos
  ...
  print(f"\n\nEl mejor Random Forest tiene un MSE de: {mse_rf}")
  ...
  return mse_rf, mejor_rf

# Ejecutar análisis de Random Forest
if __name__ == "__main__":
  run_random_forest_analysis(visualize=True)